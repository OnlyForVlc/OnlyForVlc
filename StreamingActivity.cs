...
namespace AndroidApp1
{
    ...
    public class StreamingActivity : Activity
    {
        ...
        protected override void OnResume()
        {
            ...
            var media = new Media(_mVideoView.LibVLC, "rtsp://184.72.239.149/vod/mp4:BigBuckBunny_175k.mov", Media.FromType.FromLocation);
        ...
        private void StopStream()
        {
            if (_mVideoView != null)
            {
                if (_mVideoView.MediaPlayer != null)
                {
                    ...
                    {
                        Log.Debug("StreamingActivity", "crash comes");
